...
namespace IBAR.Syncer.Infrastructure.Application.Helpers
{
    public class FileNameMatcher
    {
        ...
        public readonly string SytossOpenPositionsSqlLike = "Sytoss-Open_Positions.";
        ...
        public bool IsTradeExeReport(string fileName)
        {
            return !string.IsNullOrEmpty(fileName) &&
                   Regex.IsMatch(fileName, _fileNameRegexRepository.FileNameRegexesQuery().FirstOrDefault(f => f.FileName == "SytossTradesEXE").FileRegex, RegexOptions.IgnoreCase);
        }

        public bool IsInterestAccruaReport(string fileName)
        {
            return !string.IsNullOrEmpty(fileName) &&
                   Regex.IsMatch(fileName, _fileNameRegexRepository.FileNameRegexesQuery().FirstOrDefault(f => f.FileName == "SytossInterestAccrua").FileRegex, RegexOptions.IgnoreCase);
        }

        public bool IsTradeCommissionsDetReport(string fileName)
        {
            return !string.IsNullOrEmpty(fileName) &&
                   Regex.IsMatch(fileName, _fileNameRegexRepository.FileNameRegexesQuery().FirstOrDefault(f => f.FileName == "SytossCommissionsDet").FileRegex, RegexOptions.IgnoreCase);
        }
        ...
        public bool IsSytossOpenPositions(string fileName)
        {
            return !string.IsNullOrEmpty(fileName) &&
                   Regex.IsMatch(fileName, _fileNameRegexRepository.FileNameRegexesQuery().FirstOrDefault(f => f.FileName == "SytossOpenPositions").FileRegex, RegexOptions.IgnoreCase);
        }
    }
}